...
const FEATURES: Array<{
  ...
  },
  {
    ...
    desc: 'From closing the sale to a branded, live portal. No developers, no DNS headaches, no waiting. Any non-technical person on your team can do it.',
  },
  {
    icon: Globe,
    color: 'text-sky-300',
    ...
    desc: "Upload a logo, pick a colour. Every academy's portal looks like their own product — their logo, their colours, their subdomain. SquadOS stays invisible.",
  },
  {
    icon: BarChart3,
    ...
    desc: 'Football, physical and mental scores tracked across every session. Automated weekly reports sent to parents. Coaches rate on mobile after each session.',
  },
  {
    icon: Shield,
    color: 'text-rose-300',
    ...
    desc: "Every academy's data is completely isolated with Row Level Security. One tenant can never see another's data — regardless of which portal they're in.",
  },
]
